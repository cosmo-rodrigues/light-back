...
CREATE TABLE "faturas" (
    ...
    "energia_compensada_quantidade" INTEGER,
    "energia_compensada_preco_unitario" DECIMAL(65,30),
    "energia_compensada_tarifa_unitaria" DECIMAL(65,30),
    "energia_compensada_valor_total" DECIMAL(65,30),
